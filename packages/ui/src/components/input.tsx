  ...
  return (
    <input
      ...
      className={cn(
        ...
        'dark:bg-input/30 border-input/50 flex h-12 w-full min-w-0 rounded-2xl border bg-transparent px-3 py-1 text-base shadow-xs transition-[color,box-shadow] outline-none',
