...
const buttonVariants = cva(
  cn(
    'inline-flex font-sans items-center cursor-pointer justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all',
  ...
  ),
  {
    variants: {
      variant: {
        ...
        outline:
          'border bg-background hover:bg-accent hover:text-accent-foreground dark:bg-accent/20 dark:border-accent/60 dark:hover:bg-accent/50',
        secondary:
      ...
      size: {
        ...
        xs: `h-8 text-sm rounded-full gap-1.5 px-3.5 has-[>svg]:px-2.5 [&_svg:not([class*='size-'])]:size-4`,
        ...
        'icon-xs': 'size-5 rounded [&_svg]:size-3',
      },
    },
    defaultVariants: {
      variant: 'default',
