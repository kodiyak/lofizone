...
import Bg from '@/assets/images/img-9.png';
import MenuBg from '@/assets/images/img-6.jpg';

export const blueSky: UiTheme = {
  title: 'Blue Sky',
  ...
  membersBackground: {
    ...
    gradients: [
      ...
      {
        className:
          'bg-background bg-gradient-to-r from-transparent to-blue-800/20',
      },
      {
        className:
