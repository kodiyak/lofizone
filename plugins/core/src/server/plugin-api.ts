...
//   private constructor(
//     private readonly tracker: RoomsTracker = RoomsTracker.getInstance(),
//   ) {
...
export interface PluginServerApi {
  ...
  savePluginState(roomId: string, pluginId: string, state: any): void;
  getPluginState(roomId: string, pluginId: string): any | null;
  broadcastToRoom(
    roomId: string,
    pluginId: string,
    event: string,
